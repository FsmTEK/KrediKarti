...
$(function(){
  ...
  var cards = [{
    nome: "mastercard",
    colore: "#0061A8",
    src: "elzem/logolar/Mastercard.png"
  }, {
    nome: "visa",
    colore: "#0061A8",
    src: "elzem/logolar/Visa.png"
  }, {
    nome: "dinersclub",
    colore: "#1b5fdd",
    src: "elzem/logolar/Diners.png"
  }, {
    nome: "americanExpress",
    colore: "#1b5fdd",
    src: "elzem/logolar/American_Express.png"
  }, {
    nome: "discover",
    colore: "#1b5fdd",
    src: "elzem/logolar/discover.jpg"
  }, {
    nome: "dankort",
    colore: "#0061A8",
    src: "elzem/logolar/Dankort_logo.png"
  },{
     nome: "troy",
     colore: "#0061A8",
     src: "elzem/logolar/troy.png"
  }];
  ...
  $(".number").keyup(function(event){
    ...
    if(parseInt(number.substring(0, 2)) > 50 && parseInt(number.substring(0, 2)) < 56){
      ...
      selected_card = 5;
        $("#karttipi").val("7");
    }else if(parseInt(number.substring(0, 4)) == 9792){
      selected_card = 6;
        $("#karttipi").val("3");
    }else{
      selected_card = -1; 
  ...
  $(".expire").keypress(function(event){
    ...
    if(event.keyCode == 8 && $(".expire").val().length == 2){
      $(this).val(month);
    }
    
    if($(this).val().length === 0){
      $(".date_value").text("AY / YIL");
    }
  }).keydown(function(){
    $(".date_value").html($(this).val());
  }).focus(function(){
